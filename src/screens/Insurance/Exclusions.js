        ...
        <SafeAreaView style={styles.container}> 
            <ScrollView style={{}}>
                <View style={styles.textSection}>
                    <Text style={{marginLeft:20,color:'#333',fontSize:16,fontFamily:'Roboto-Medium',}}>Policy Exclusions</Text>
                </View>
                <View style={{borderBottomWidth:1,borderBottomColor:'#93968F'}}>
                    <View style={styles.section}>
                        ...
                        <Text style={styles.txt}>Any item or condition or tretment specified list of Non-Medical Item</Text>
                        </View>
                    </View>
                </View>
                <View style={{borderBottomWidth:1,borderBottomColor:'#93968F'}}>
